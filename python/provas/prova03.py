...
1 - Adicionar palavra: adiciona uma nova palavra digitada pelo usuário ao final do
arquivo “palavras.txt”. O arquivo não deve conter palavras duplicadas. As
palavras são armazenadas uma por linha.
2 - Excluir palavra: exclui a palavra digitada pelo usuário do arquivo
“palavras.txt”.
